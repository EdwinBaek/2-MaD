...
def train_main(seq_length, train_dir, test_dir, valid_dir, vocab_dir, train_batch, valid_batch, test_batch, method):
    ...
    train_model(seq_length, embedding_dim1, train_dir, test_dir, valid_dir, vocab_dir, '%s_word2vec_model_100' % method,
                    'word2vec', train_batch, valid_batch, test_batch, layer=1, cell1=128, cell2=0)
    train_model(seq_length, embedding_dim2, train_dir, test_dir, valid_dir, vocab_dir, '%s_word2vec_model_200' % method,
                    'word2vec', train_batch, valid_batch, test_batch, layer=1, cell1=128, cell2=0)
    train_model(seq_length, embedding_dim3, train_dir, test_dir, valid_dir, vocab_dir, '%s_word2vec_model_300' % method,
                    'word2vec', train_batch, valid_batch, test_batch, layer=1, cell1=128, cell2=0)
    
    # method 1 - 1 layer & 128 cells - fasttext 100, 200, 300 train
    train_model(seq_length, embedding_dim1, train_dir, test_dir, valid_dir, vocab_dir, '%s_fasttext_model_100' % method,
                    'fasttext', train_batch, valid_batch, test_batch, layer=1, cell1=128, cell2=0)
    train_model(seq_length, embedding_dim2, train_dir, test_dir, valid_dir, vocab_dir, '%s_fasttext_model_200' % method,
                    'fasttext', train_batch, valid_batch, test_batch, layer=1, cell1=128, cell2=0)
    train_model(seq_length, embedding_dim3, train_dir, test_dir, valid_dir, vocab_dir, '%s_fasttext_model_300' % method,
                    'fasttext', train_batch, valid_batch, test_batch, layer=1, cell1=128, cell2=0)
...
def main():
    ...
    base_dir = './data/train'
    train_dir3 = os.path.join(base_dir, 'BSY_train.txt')
    test_dir3 = os.path.join(base_dir, 'BSY_test.txt')
    valid_dir3 = os.path.join(base_dir, 'BSY_valid.txt')
    vocab_dir3 = os.path.join(base_dir, 'BSY_word_vocab.txt')

    train_main(seq_length, train_dir3, test_dir3, valid_dir3, vocab_dir3, train_batch, valid_batch, test_batch, method='BSY')


main()

# print("embedding model loading...")
# vocab_dir = './data/train/BSY_word_vocab.txt'
# model_name = 'BSY_fasttext_model_100'
# # changable
# word_vocab_name = '%s' % vocab_dir
# word2vec_file_name = './embedding_model/%s' % model_name
#
...
#         if min(embedding_vector) <= min_value:
#             print("find min")
#             print(min(embedding_vector))
#             min_value = min(embedding_vector)
#         if max(embedding_vector) >= max_value:
#             print("find max")
#             print(max(embedding_vector))
